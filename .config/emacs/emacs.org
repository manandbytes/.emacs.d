...
| [[https://stable.melpa.org/packages/][melpa-stable]] | y       | Milkypostman’s Emacs Lisp Package Archive, built from the latest tagged code in those repositories, where version tags exist. |        0 |
