 ...
 '(url-proxy-services
   (quote
    (("no_proxy" . "\\(localhost\\|127\\.0\\.0\\.0/8\\|::1\\)")
     ("http" . "127.0.0.1:3128"))))
 '(org-agenda-custom-commands (quote (("r" tags-todo "REFILE" nil) ("W" "Weekly review" ((agenda "" ((org-agenda-ndays 7))) (stuck "") (tags "PROJECT") (todo "SOMEDAY") (todo "WAITING")) "" nil) ("p" tags "+PROJECT" nil))))
