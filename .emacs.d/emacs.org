...
Loading should be defferred and take place as late as possible.
...
#+BEGIN_SRC emacs-lisp
  (el-get-bundle org-mode
    ...
    (with-eval-after-load-feature (org org-clock apt-utils)
...
Start the overview always on the current day and not on the weekday:
#+BEGIN_SRC emacs-lisp
