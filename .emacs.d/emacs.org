...
#+BEGIN_SRC emacs-lisp
  ...
  (el-get-bundle org-link-travis :pkgname "manandbytes/org-link-travis" :type github
    :depends (org-mode)
    :after (progn
             (org-add-link-type "travis-build" 'org-link-travis/open-build-link)))

  (el-get-bundle nhexl-mode :pkgname "emacsmirror/nhexl-mode" :type github)
  ...
  (el-get-bundle puppet-flymake :pkgname "grimradical/puppet-flymake" :type github)
#+END_SRC
