...
#+BEGIN_SRC emacs-lisp :tangle no :results org code :var packages='("ag" "projectile" "seq" "prolog-el" "helm-projectile")'
...
#+BEGIN_SRC emacs-lisp :var packages='("projectile" "ag")' :results org code
  (mapcar (lambda (package)
